...
- Deploy key: [GitHub repo `BCFNGS-project-management`](https://github.com/example-org/example-repo) -> `Settings` -> `Deploy keys` -> `Add deploy key`.
...
```bash
cd /Users/exampleuser/Documents/Github/example-repo
...
remote:      https://github.com/example-org/example-repo/pull/new/additional-cost-notifications
remote:
To github.com:exampleuser/BCFNGS-project-management.git
...
```bash
cd /home/exampleuser/example-repo
git checkout main
git pull --ff-only origin main
