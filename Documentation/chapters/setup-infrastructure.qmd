...
- Numbered list:
  - `1. first`
  - `2. second`
- Link: `[@NGS](mailto:ngs@example.org)`
...
- App render + admin handlers:
  - `/Users/exampleuser/Documents/Github/example-repo/sequencing-app/app.R`
...
PING ngs-testing-vm.biochem.mpg.de (192.0.2.60) 56(84) bytes of data.
64 bytes from ngs-testing-vm.biochem.mpg.de (192.0.2.60): icmp_seq=1 ttl=64 time=0.079 ms
64 bytes from ngs-testing-vm.biochem.mpg.de (192.0.2.60): icmp_seq=2 ttl=64 time=0.074 ms
```
...
-rw------- 1 exampleuser b_mcf 3272 Nov 10 15:58 private-key.pem # udo chmod 600 /path/to/private.key  # Readable only by root
-rw-r--r-- 1 exampleuser b_mcf 1545 Nov 14 12:12 NGS_2026_Issuer_ChainFile.cer # sudo chmod 644 /path/to/chain.crt  # Readable by all
-rw-r--r-- 1 exampleuser b_mcf 2796 Nov 14 12:34 NGS_2026_Cert.pem # sudo chmod 644 /path/to/certificate.crt # Readable by all
```
