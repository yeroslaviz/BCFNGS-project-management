...
- [VHost cutover (perl‑VM → shiny‑VM)](#vhost-cutover-perlvm--shinyvm)
...
### Step 2: Optional: redirect the old hostname
...
### Step 3: Baseline environment checks
...
### Step 4: Manual curl validation (reference)
