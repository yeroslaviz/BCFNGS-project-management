...
- [Feature Branch Deploy (Test VM)](#feature-branch-deploy-test-vm)
...
In `/Users/exampleuser/Documents/Github/example-repo/sequencing-app/app.R`:
...
```{bash}
git -C /home/exampleuser/example-repo remote -v
```
...
- `/home/exampleuser/example-repo/sequencing-app/`
...
```bash
LDAP_TEST_USER="exampleuser-test" LDAP_TEST_PASSWORD="YOUR_PASSWORD" ./scripts/deploy.sh
```
...
2. Deploy branch code to `/srv/shiny-server/sequencing-app/`.
...
sudo cp /home/exampleuser/example-repo/scripts/ngs-vm-perl-9443.conf /etc/apache2/sites-available/ngs-vm-perl-9443.conf
```
