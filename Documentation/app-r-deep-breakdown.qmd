...
This file is a comprehensive companion to `/Users/yeroslaviz/Documents/Github/BCFNGS-project-management/sequencing-app/app.R` (currently ~5,490 lines).
...
| `4892-5343` | Edit/delete/update project workflows + status updates | High-level block in app startup/runtime path. |
| `5345-5487` | Backup/restore and optional auto-backup block (commented) | High-level block in app startup/runtime path. |
| `5490-5490` | Application entrypoint (`shinyApp(ui, server)`) | High-level block in app startup/runtime path. |
...
| `confirm_status_update_btn` | 5255 | actionButton | 5271 | Apply for Projects / Projects table |
| `create_project_btn` | 2909 | actionButton | 3079 | Apply for Projects / Projects table |
...
| `edit_project_btn` | 2789 | actionButton | 4895 | Apply for Projects / Projects table |
...
| `update_project_btn` | 4919 | actionButton | 5027 | Apply for Projects / Projects table |
...
| `update_status_btn` | 2800 | actionButton | 5236 | Apply for Projects / Projects table |
...
- **Defined at:** `/Users/yeroslaviz/Documents/Github/BCFNGS-project-management/sequencing-app/app.R:1998`
...
- **Defined at:** `/Users/yeroslaviz/Documents/Github/BCFNGS-project-management/sequencing-app/app.R:2020`
- **Signature line:** `calculate_total_cost <- function(num_samples, service_type_id, sequencing_depth_id, sequencing_cycles_id) {`
- **Purpose:** Computes estimated project cost from samples + service + depth/cycles rules.
- **Called/referenced at:** not detected directly (may be invoked via nested closure/runtime path).

### `send_project_creation_email` {#fn-send-project-creation-email}
- **Defined at:** `/Users/yeroslaviz/Documents/Github/BCFNGS-project-management/sequencing-app/app.R:2051`
- **Signature line:** `send_project_creation_email <- function(project_data, budget_holder, user_email) {`
- **Purpose:** Builds and sends project-created email to creator + budget holder + facility mailbox.
- **Called/referenced at:** not detected directly (may be invoked via nested closure/runtime path).

### `send_data_released_email` {#fn-send-data-released-email}
- **Defined at:** `/Users/yeroslaviz/Documents/Github/BCFNGS-project-management/sequencing-app/app.R:2151`
...
- **Defined at:** `/Users/yeroslaviz/Documents/Github/BCFNGS-project-management/sequencing-app/app.R:2732`
...
- **Defined at:** `/Users/yeroslaviz/Documents/Github/BCFNGS-project-management/sequencing-app/app.R:3055`
...
- **Defined at:** `/Users/yeroslaviz/Documents/Github/BCFNGS-project-management/sequencing-app/app.R:5062`
...
- **Defined at:** `/Users/yeroslaviz/Documents/Github/BCFNGS-project-management/sequencing-app/app.R:5069`
...
| 2903 | `input$new_project_btn` | Apply for Projects / Projects table | Opens project-create modal and auto-selects budget holder by group mapping. |
| 3079 | `input$create_project_btn` | Apply for Projects / Projects table | Validates, inserts new project, sends creation email, and refreshes project table. |
...
| 4895 | `input$edit_project_btn` | Apply for Projects / Projects table | Opens edit modal for selected project with permission checks. |
| 5027 | `input$update_project_btn` | Apply for Projects / Projects table | Updates selected project row and optionally sends data-released email. |
...
| 5236 | `input$update_status_btn` | Apply for Projects / Projects table | Opens status-update modal (admin only). |
| 5271 | `input$confirm_status_update_btn` | Apply for Projects / Projects table | Writes new status and sends data-released email when applicable. |
...
- Primary flows: `input$new_project_btn` -> modal; `input$create_project_btn` writes DB + sends email; `input$edit_project_btn` and `input$update_project_btn` modify rows.
...
- **Create project modal**: `/Users/yeroslaviz/Documents/Github/BCFNGS-project-management/sequencing-app/app.R:2903` (open), `:3079` (submit).
- **Edit project modal**: `/Users/yeroslaviz/Documents/Github/BCFNGS-project-management/sequencing-app/app.R:4895` (open), `:5027` (submit).
- **Status update modal**: `/Users/yeroslaviz/Documents/Github/BCFNGS-project-management/sequencing-app/app.R:5236` (open), `:5271` (submit).
- **Landing text management**: `/Users/yeroslaviz/Documents/Github/BCFNGS-project-management/sequencing-app/app.R:3571` and CRUD events `:3765` onward.
...
- **DB backup/restore UI**: `/Users/yeroslaviz/Documents/Github/BCFNGS-project-management/sequencing-app/app.R:2876-2893`; handlers at `:5350-5414`.
...
4. Read `send_project_creation_email()` and `send_data_released_email()` for notification side-effects.
